<template>
    <footer class="w-full h-[45px] grid grid-cols-4 gap-0.5 justify-between bg-slate-900 overflow-hidden">
        ...
        <a href="/rewards" class="group w-full flex justify-center items-center bg-amber-200 hover:bg-amber-700">
            <svg class="size-8 text-amber-700 font-bold text-lg tracking-wider uppercase group-hover:text-amber-200" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <a href="/help" class="group w-full flex justify-center items-center bg-amber-200 hover:bg-amber-700">
            <svg class="size-8 text-amber-700 font-bold text-lg tracking-wider uppercase group-hover:text-amber-200" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
